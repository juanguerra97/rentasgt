...
CREATE TABLE `Products` (
    ...
    `Location_StaticMap` longtext CHARACTER SET utf8mb4 NULL,
...
CREATE TABLE `UserProfileEvents` (
    ...
    `UserProfileId` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
    `UserEventId` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `RentRequests` (
    ...
    `ProductId` bigint NOT NULL,
    `RequestorId` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `Conflicts` (
    ...
    `ComplainantId` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
